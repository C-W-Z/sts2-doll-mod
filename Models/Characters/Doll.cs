...
namespace Doll.Models.Characters;

public sealed class Doll : PlaceholderCharacterModel
{
    // 角色名称颜色
    public override Color NameColor => StsColors.pink;
    // 能量图标轮廓颜色
    public override Color EnergyLabelOutlineColor => StsColors.pink;
    ...
    // 人物选择图标-锁定状态。
    public override string CustomCharacterSelectLockedIconPath => "res://images/char_select_locked.png";
    // 人物选择过渡动画。
    ...
    public override CardPoolModel CardPool => ModelDb.CardPool<DollCardPool>();
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<DollRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<DollPotionPool>();
